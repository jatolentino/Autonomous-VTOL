function [theta_ref, phi_ref, U1,ex,exdot,vx,ey,eydot,vy,ez,ezdot,vz] = positionControl(...
    states,x_ref,x_dot_ref,x_dotdot_ref,y_ref,y_dot_ref,y_dotdot_ref,z_ref,z_dot_ref,z_dotdot_ref,psi_ref)
pCs = plantConstants1;
...
k1 = -1; k2 = -1; %radious 5 testing in -4 and -4
%k1 = -1e-04; k2 = -5e-05;
ux = k1*ex + k2*exdot;  % ux=edotdotx
uy = k1*ey + k2*eydot;  % uy=edotdoty
uz = k1*ez + k2*ezdot;  % uz=edotdotz
